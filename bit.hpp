...
/*
Bit (single logic value)

- Models a single binary value (0 or 1) with logic gate operator overloads.
- Follows separation of concerns (SOC): each gate is implemented as a distinct operator or method.
- Used as the atomic unit for combinational and sequential circuit modeling.
...
- Useful for building combinational logic circuits, adders, and higher-level digital designs.
*/
class Bit {
